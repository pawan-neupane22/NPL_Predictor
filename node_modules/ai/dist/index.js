...
// src/version.ts
var VERSION = true ? "7.0.68" : "0.0.0-test";
...
// src/generate-text/tool-caller-configuration.ts
import {
...
function splitArray(array3, chunkSize) {
  ...
  for (let i = 0; i < array3.length; i += chunkSize) {
    result.push(array3.slice(i, i + chunkSize));
  }
  return result;
}
          ...
          async transform(chunk, controller) {
            ...
            switch (chunk.type) {
              ...
              case "finish": {
                ...
                try {
                  object3 = await parseAndValidateObjectResultWithRepair(
                    accumulatedText,
                    outputStrategy,
                    repairText,
                    {
...
// src/middleware/default-instructions-middleware.ts
import { asArray as asArray7 } from "@ai-sdk/provider-utils";
function defaultInstructionsMiddleware({
  instructions
}) {
  const defaultSystemMessages = typeof instructions === "string" ? [{ role: "system", content: instructions }] : asArray7(instructions).map((message) => ({
    role: "system",
    content: message.content,
    providerOptions: message.providerOptions
  }));
...
import { asArray as asArray10 } from "@ai-sdk/provider-utils";
var wrapImageModel = ({
  model: inputModel,
  middleware: middlewareArg,
  modelId,
  ...
  return [...asArray10(middlewareArg)].reverse().reduce((wrappedModel, middleware) => {
