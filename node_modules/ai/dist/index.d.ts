 ...
 */
type Experimental_GeneratedImage = GeneratedFile;
...
declare const uiMessageChunkSchema: _ai_sdk_provider_utils.LazySchema<UIMessageChunk<unknown, UIDataTypes>>;
 ...
 */
type BatchLanguageModel = GlobalProviderModelId | Experimental_BatchLanguageModelV4;
/**
 * The persisted reference for a text batch.
 */
type TextBatchReference = {
    readonly version: 1;
    readonly type: 'text';
    readonly id: string;
    readonly provider: string;
 ...
 */
type BatchReference = TextBatchReference;
/**
 * Serializable error information for a batch or batch item.
 */
type BatchError = Experimental_BatchV4Error;
/**
 * The latest normalized lifecycle status for a batch.
 */
type BatchStatus = Experimental_BatchV4Status;
/**
 * A text batch and its latest normalized lifecycle status.
 */
type TextBatch = TextBatchReference & BatchStatus;
/**
 * One text generation request within a batch.
 */
type TextBatchRequest = Prompt & LanguageModelCallOptions & {
    id: string;
    providerOptions?: ProviderOptions;
};
 ...
 */
type StartTextBatchResult = TextBatch & {
    readonly warnings: Experimental_BatchV4StartResult['warnings'];
};
/**
 ...
 */
declare function startTextBatch({ model: modelArg, requests, providerOptions, abortSignal, headers, timeout, }: StartTextBatchOptions): Promise<StartTextBatchResult>;
/**
 ...
 */
type SpeechTranslationModelResponseMetadata = {
    /**
     * Timestamp for the start of the generated response.
     */
    timestamp: Date;
 ...
 */
declare function defaultInstructionsMiddleware({ instructions, }: {
    /**
 ...
 * change in patch releases.
 */
type SpeechTranslationModel = string | Experimental_SpeechTranslationModelV4;
...
interface StreamTranslationResult {
    /**
