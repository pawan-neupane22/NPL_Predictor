...
type GatewayRealtimeModelId = 'openai/gpt-realtime-1.5' | 'openai/gpt-realtime-2' | 'openai/gpt-realtime-2.1' | 'openai/gpt-realtime-mini' | 'xai/grok-voice-think-fast-1.0' | 'xai/grok-voice-think-fast-2.0' | (string & {});
...
declare class GatewayForbiddenError extends GatewayError {
    ...
    constructor({ message, statusCode, cause, generationId, ruleId, }?: {
        message?: string;
        statusCode?: number;
        cause?: unknown;
        generationId?: string;
